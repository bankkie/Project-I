...
<form class="well form-horizontal" method="POST" action={{url('/create_stf')}} id="contact_form">
    {{ csrf_field() }}
<fieldset>
...
<div class="form-group">
  <label class="col-md-4 control-label">SS Card</label>  
    <div class="col-md-4 inputGroupContainer">
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-envelope"></i></span>
...
<div class="form-group">
  <label class="col-md-4 control-label">Tex No</label>  
   <div class="col-md-4 inputGroupContainer">
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-globe"></i></span>
  <input name="tex_no" placeholder="tex_no" class="form-control" type="text">
    </div>
  </div>
</div>
...
<div class="form-group">
  <label class="col-md-4 control-label">Begin date</label>  
    ...
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-envelope"></i></span>
  <input name="begin_date" class="form-control"  type="date">
    </div>
  </div>
</div>
...
<<div class="form-group">
  <label class="col-md-4 control-label">Ext</label>  
   <div class="col-md-4 inputGroupContainer">
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-globe"></i></span>
  <input name="ext" placeholder="Ext" class="form-control" type="text">
    </div>
  </div>
</div>
<div class="form-group">
