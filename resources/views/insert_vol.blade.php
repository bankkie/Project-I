...
<div class="wrapper row1">
  <header id="header" class="hoc clear"> 
    ...
    <div id="logo" class="fl_left">
      <h1><a href="index.html">International One Stop Service</a></h1>
    </div>
    <nav id="mainav" class="fl_right">
      <ul class="clear">
        ...
        <li><a class="drop" href="#">Profile</a>
          <ul>
            <li><a href="pages/gallery.html">show</a></li>
            <li><a href="pages/full-width.html">Edit</a></li>
            
          </ul>
        </li>
        <li><a class="drop" href="#">Volnteer</a>
          <ul>
...
<form method="POST" action={{url('/create_vol')}}>
    {{ csrf_field() }}
<fieldset>
<br><legend>Insert Volunteer</legend>

<p>Student id</p><input name="std_id" type="text" >
<p>Name</p><input name="name" type="text" >
<p>Nickname</p><input name="nickname" type="text" >
<p>email</p><input name="email" type="text" >
<p>reason</p><input name="reason" type="text" >
